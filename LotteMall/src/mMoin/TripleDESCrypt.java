...
public class TripleDESCrypt 
{
	...
	public String base64Decrypt(String str, String charset)
	{
		try
		{
			return new String(decrypt(new BASE64Decoder().decodeBuffer(str)), charset);
		}
		catch (Exception e)
		{
			return null;
	...
	public static void main(String args[])
	{
		...
		TripleDESCrypt crypt = new TripleDESCrypt(args[0], charSet);
		System.out.println("text = " + args[1]);
		
		/*
		String encoded = crypt.base64Encrypt(args[1], charSet);
		System.out.println("base64encoded = " + encoded);
		System.out.println("base64decoded = " + crypt.base64Decrypt(encoded, charSet));
		encoded = crypt.hexEncrypt(args[1], charSet);
		System.out.println("hexencoded = " + encoded);
		System.out.println("hexdecoded = " + crypt.hexDecrypt(encoded, charSet));
		*/
//		String decoded = crypt.base64Decrypt(args[1], charSet);
//		System.out.println("base64decoded = " +decoded);
		String decoded = crypt.hexDecrypt(args[1], charSet);
		System.out.println("hexdecoded = " + decoded); //11058
