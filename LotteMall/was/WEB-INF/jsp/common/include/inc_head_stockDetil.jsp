...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=2, target-densitydpi=device-dpi">
...
<script src="/phone/common/js/iscroll/iscroll.js"></script>
...
<script src="/phone/common/js/common/UI-0.1.min.js"></script>
