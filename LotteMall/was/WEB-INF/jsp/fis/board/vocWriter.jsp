	...
	<div class="container">
		<form role="contentsForm" method="post">
			<input type="hidden" id="user_name" name="user_name" value=${user_name}> <label for="title">제목 : </label><input
				type="text" id="title" name="title" style="width: 100%;"> <br>
			<div align="right">
				<label for="secret_flag">비밀글 :&nbsp&nbsp</label><input type="checkbox" id="secret_flag" name="secret_flag" value="yes">
			</div>
